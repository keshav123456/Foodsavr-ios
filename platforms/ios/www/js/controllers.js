...
.controller('justlistCtrl', function($scope, $rootScope, $ionicModal, $http, fbFactory, $localStorage ) {
...
.controller('loginCtrl', ['$scope','fbFactory','$state','$rootScope', function($scope, fbFactory, $state,$rootScope, $localStorage) {
...
$scope.items.$add({'pic':$scope.picture,'prod':$scope.desc,'price':$scope.price,'discount':$scope.discount,'storeloc':$scope.storeloc,'suppliername':$scope.suppliername,'datetime':tempdate});	  //alert("sending image");
